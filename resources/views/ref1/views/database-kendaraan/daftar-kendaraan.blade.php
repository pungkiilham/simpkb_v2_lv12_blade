...
@section('konten')
    <div class="main-panel">
                ...
                <div class="row">
                    <div class="col-12" id="daftarKegiatan">
                        <div class="daftar-kegiatan__heading mb-4">
                            <div>
                                <h1 class="text-3xl text-dark font-weight-bold">Daftar Seluruh Kendaraan</h1>
                            </div>
                        </div>
                        <div class="daftar-kegiatan__table">
                            <div class="daftar-kegiatan__table-tools" style="min-width:800px;">
                                ...
                                <div class="w-auto">
                                    ...
                                    <a type="button" class="btn btn-base" href="{{ URL::to('/') }}/buatdata-kendaraan"
                                        style="background-color: #e7921b;">Tambah
                                        Kendaraan</a>
                                    <a type="button" class="btn btn-base" data-toggle="modal"
                                        data-target="#uploadModalLabel" style="background-color: #2559b9;">Import
                                        CSV</a>
                                ...
                                <table class="table table-hover table-bordered" style="min-width: 500px; width: 100%">
                                    <thead style="background-color: #e4e4e4;">
                                        <tr>
                                            ...
                                            <th class="text-center font-weight-bold">No. Pol</th>
                                            ...
                                            <th class="text-center font-weight-bold">Habis Uji</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center" style="width: 450px"></td>
                                            <td class="text-center" style="width: 150px"></td>
                                            <td class="text-center" style="width: 150px"></td>
                                            <td class="text-center" style="width: 150px"></td>
                                            <td class="text-center" style="width: 150px"></td>
                                            ...
                                            <td class="text-center" style="padding:25px"><a type="button"
                                                    class="btn btn-base" href="{{ URL::to('/') }}/detail-kendaraan"
                                                    style="background-color: #1b73e7;">Lihat</a></td>
                                        </tr>
                                    </tbody>
                                </table>
        ...
        <!-- Modal Upload File -->
        <div class="modal fade bd-example-modal-lg" tabindex="-1" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" role="dialog" id="uploadModalLabel">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content bg-white">
                    <div class="modal-body p-5">
                        <div class="text-center text-2xl text-dark font-weight-bold mb-4">Upload File</div>
                        <form
                            class="dropzone" method="post" enctype="multipart/form-data"
                            style="border: dotted;border-radius: 5px;">
                            <div class="dz-message d-flex flex-column" data-dz-message>
                                <span><img src="assets_admin/images/upload.png"
                                        alt="" style="width: 32px; margin-bottom: 10px" /></span>
                                <span>Drag & Drop your file here or <span class="text-primary">browse</span></span>
                            </div>
                        </form>
                        <button type="submit" class="btn btn-base btn-primary float-right mt-5">Upload</button>
                    </div>
                </div>
            </div>
        </div>
