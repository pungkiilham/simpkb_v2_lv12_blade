                ...
                <div class="row">
                    <div class="col-12" id="daftarKegiatan">
                        <div class="daftar-kegiatan__heading mb-4">
                            <div>
                                <h1 class="text-3xl text-dark font-weight-bold">Informasi Lengkap Kendaraan</h1>
                            </div>
                        </div>
                            ...
                            <div class="daftar-kegiatan__table-tools" style="min-width:800px;">
                                ...
                                <div class="w-auto">
                                    ...
                                    <a type="button" class="btn btn-base"
                                        href="{{ URL::to('/') }}/ubahdata-kendaraan"
                                        style="background-color: #e7921b;">Ubah Data</a>
                        ...
                        <div class="card-body">
                            <form>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="namaPemilik" type="text" style="color:black" readonly
                                        value="">
                                </div>
