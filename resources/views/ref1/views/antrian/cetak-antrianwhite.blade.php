        ...
        <div class="modal-body navbar-body " style="margin: 20px 16px 20px 16px;  !important;">
            <div class="container-fluid-body row" style="column-gap: 20px;">
                    ...
                    <div class="style-margin-xxxl style-margin-xxl style-margin-l style-margin-m">
                        <div class="home-header">
                            ...
                            <h1
                                ...
                                UPT PENGUJIAN KENDARAAN BERMOTOR</br>DISHUB KOTA BATU</h1>
                        </div>
                        ...
                        <div class="home-db-info ">
                            <div class="home-db-list">
                                <div class="type-style-isi-xxxl type-style-isi-xxl type-style-isi-l type-style-isi-m">
                                    <p> Silahkan mengambil nomor antrian sesuai keperluan Anda:</p>
                                    <p> Loket 1: Untuk pengujian baru & berkala</p>
                                    <p> Loket 2: Untuk mutasi, numpang uji, permohonan, dll</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lgm-4 col-lg-4 col-xxl-4 col-xxxl-4  rounded-4"
                    ...
                    {{-- <div class="style-margin-m"> --}}
                        <div class="hp-xxxl hp-xxl hp-l hp-m">
                        <div class="row justify-content-md-center">
                            <div class="card border-dark mb-3"
                                style="max-width: 500px; max-height:400px; margin-top: 65px; background-color: #ffffff; box-shadow: 0.7px 3px ;">
                                <div class="card-header"
                                    style="text-align: center; font-size: 40px; font-weight: bold; background-color: #e0e0e0; margin-top: 15px">
                                    No Antrian Loket 1</div>
                                <div class="card-body">
                                    <h1 class="card-text"
                                        style="text-align: center;-webkit-text-fill-color: #3333e8; font-size: 80px">
                                        A-1</h1>
                                </div>
                                <a href="#" class="btn"
                                    style="margin-bottom: 15px; background-color: #04b593; font-size: 40px; font-weight: bold;">Cetak
                                    Antrian</a>
                            </div>
                        </div>
