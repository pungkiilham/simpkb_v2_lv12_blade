                ...
                <div class="row">
                    <div class="col-12" id="daftarKegiatan">
                        <div class="daftar-kegiatan__heading mb-4">
                            <div>
                                <h1 class="text-3xl text-dark font-weight-bold">Riwayat Pendaftaran Uji Harian</h1>
                            </div>
                        </div>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <label for="tugas" class="form-label text-base text-dark font-weight-bold"
                                            ...
                                            Periode: </label>
                                        <input type="text" class="form-control" id="nama" data-provide="datepicker" placeholder="Tanggal awal" style="margin-right: 20px">
                                        <input type="text" class="form-control" id="nama" data-provide="datepicker" placeholder="Tanggal akhir">
                                    </div>
                                </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-left" style="width: 300px">Nopol:<br /><br /> No
                                                Rangka:<br /><br /> Jenis Kendaraan:<br /><br /> Jenis Pengujian:</td>
