                ...
                <div class="row">
                    <div class="col-12" id="daftarKegiatan">
                        <div class="daftar-kegiatan__heading mb-4">
                            <div>
                                <h1 class="text-3xl text-dark font-weight-bold">Daftar Kendaraan Siap Diuji</h1>
                            </div>
                        </div>
                        <div class="daftar-kegiatan__table">
                            <div class="daftar-kegiatan__table-tools" style="min-width:800px;">
                                ...
                                <div class="w-auto">
                                    ...
                                    {{-- <a type="button" class="btn btn-base" href="{{ URL::to('/') }}/aktifitaspengujian"
                                        style="background-color: #218f52;margin-left: 10px">Aktifitas Pengujian</a> --}}
                                </div>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" style="padding:25px"><a type="button"
                                                ...
                                                <a type="button" class="btn btn-base" href=""
                                                    style="background-color: #e7921b;">Cetak BAP TL</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="text-center" style="padding:25px">
                                                ...
                                                <br /><br />
                                                <a type="button" class="btn btn-base" href=""
                                                    style="background-color: #d32121;">Sinkron Ulang</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="text-center" style="padding:25px"><a type="button"
                                                    class="btn btn-base" href="{{ URL::to('/') }}/pengujian"
                                                    style="background-color: #218f52;">Mulai Uji</a></td>
                                        </tr>
                                        <tr>
                                            <td class="text-center" style="width: 25px">3</td>
                                            {{-- <td class="text-center" style="width: 150px"></td> --}}
                                            ...
                                            <td class="text-center" style="width: 150px"></td>
                                            <td class="text-left" style="width: 300px">Berlangsung</td>
                                            <td class="text-center" style="padding:25px"><a type="button"
                                                    class="btn btn-base" href="{{ URL::to('/') }}/pengujian"
                                                    style="background-color: #e7921b;">Lanjut Uji</a></td>
                                        </tr>
                                    </tbody>
                                </table>
