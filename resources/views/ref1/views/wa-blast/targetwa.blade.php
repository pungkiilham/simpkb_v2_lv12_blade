                ...
                <div class="row">
                    <div class="col-12" id="daftarKegiatan">
                        <div class="daftar-kegiatan__heading mb-4">
                            <div>
                                <h1 class="text-3xl text-dark font-weight-bold">Daftar Kendaraan Telah Mati Uji</h1>
                            </div>
                        </div>
                        ...
                        <div class="daftar-kegiatan__table-tools" style="min-width:800px;">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <input type="text" class="form-control" id="nama" data-provide="datepicker"
                                        placeholder="Batas Mati Uji" style="margin-right: 20px">
                                    {{-- <input type="text" class="form-control" id="nama" data-provide="datepicker"
                            ...
                            <div class="w-auto">
                                ...
                                style="background-color: #e7921b;">Blast Pesan WA</button>
                                <a type="button" class="btn btn-base" href="{{ URL::to('/') }}/riwayat-blast"
                                style="background-color: #218f52;">Riwayat Blast WA</a>
                                {{-- <button type="button" class="btn btn-base" onclick=""
                                    style="background-color: #218f52;">Export CSV</button> --}}
                                <a type="button" class="btn btn-base"  href="{{ URL::to('/') }}/pengaturanwa"
                                    style="background-color: #d32121;">Pengaturan</a>
                            </div>
                        </div>
