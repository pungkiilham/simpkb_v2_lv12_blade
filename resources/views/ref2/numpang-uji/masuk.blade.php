...
@section('title', 'Numpang Uji Masuk')
@section('header', 'Numpang Uji Masuk')
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-4">
                <h3 class="text-lg font-semibold text-gray-800">Daerah Asal</h3>
    ...
    <!-- Form Section -->
    <div class="bg-white rounded-xl shadow-sm p-6">
        <h3 class="text-lg font-semibold text-gray-800 mb-6">Data Numpang Uji Masuk</h3>
        <form class="space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Nomor Uji Asal</label>
    ...
    <!-- Recent Table -->
    <div class="bg-white rounded-xl shadow-sm p-6">
        <h3 class="text-lg font-semibold text-gray-800 mb-6">Riwayat Numpang Uji Masuk</h3>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Daerah Asal</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm">DKI Jakarta</td>
