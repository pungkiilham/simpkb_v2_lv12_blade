...
<div class="space-y-6">
    ...
    <!-- Form Section -->
    <div class="bg-white rounded-xl shadow-sm p-6">
        <h3 class="text-lg font-semibold text-gray-800 mb-6">Data Mutasi Keluar</h3>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        <h3 class="text-lg font-semibold text-gray-800 mb-6">Riwayat Mutasi Keluar</h3>
