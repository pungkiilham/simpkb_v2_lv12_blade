...
<div class="space-y-6">
    ...
    <!-- Form Section -->
    <div class="bg-white rounded-xl shadow-sm p-6">
        <h3 class="text-lg font-semibold text-gray-800 mb-6">Data Mutasi Masuk</h3>
        <form class="space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Status Mutasi</label>
                    <select class="w-full rounded-lg border-gray-300">
    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        <h3 class="text-lg font-semibold text-gray-800 mb-6">Riwayat Mutasi Masuk</h3>
