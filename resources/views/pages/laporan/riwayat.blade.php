        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
                <div class="flex items-center justify-start">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-800 mb-2">Riwayat Pelayanan</h1>
                        <p class="text-gray-600">Riwayat Kendaraaan Menggunakan Layanan</p>
                    </div>
                </div>
                ...
                <div class="grid md:grid-cols-4 grid-cols-2 gap-4 items-end">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            <option value="3">Numpang Masuk</option>
                            <option value="">Numpang Keluar</option>
                            <option value="">Mutasi Masuk</option>
                            <option value="">Mutasi Keluar</option>
                            <option value="">Perubahan</option>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-2 py-2 text-sm text-center whitespace-nowrap">
                                <div class="flex justify-center items-center space-x-2">
                                    <a href="/lihatriwayat" class="text-blue-600 hover:text-blue-800" title="Lihat">
