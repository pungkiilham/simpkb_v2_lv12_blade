{{-- resources/views/pages/masterKendaraan/components/tambah3.blade.php --}}
<div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <select name="jenis_bahan_bakar_id"
                        ...
                        <option value="1" {{ old('jenis_bahan_bakar_id') == '1' ? 'selected' : '' }}>Bensin</option>
                        <option value="2" {{ old('jenis_bahan_bakar_id') == '2' ? 'selected' : '' }}>Solar</option>
                        <option value="3" {{ old('jenis_bahan_bakar_id') == '3' ? 'selected' : '' }}>CNG/LPG</option>
                        <option value="4" {{ old('jenis_bahan_bakar_id') == '4' ? 'selected' : '' }}>Listrik</option>
                        <option value="5" {{ old('jenis_bahan_bakar_id') == '5' ? 'selected' : '' }}>Lain Lain</option>
                    </select>
