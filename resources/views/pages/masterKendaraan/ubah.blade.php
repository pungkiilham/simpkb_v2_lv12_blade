        ...
        <div class="bg-white rounded-xl shadow-lg p-3 md:p-4 mb-4">
            ...
            <div class="flex items-center justify-between mb-4">
                <div class="flex items-center">
                    ...
                    <div>
                        <h1 class="text-xl md:text-2xl font-bold text-gray-800">Ubah Data Kendaraan</h1>
        ...
        <div class="bg-white rounded-xl shadow-lg p-3 md:p-6">
            <form action="{{ route('kendaraan.update', $kendaraan->kendaraan_id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
                    ...
                    <div class="space-y-6">
                        {{-- Data kendaraan --}}
                        @include('pages.masterKendaraan.components.ubah1')
                    </div>

                    <!-- Right Column -->
                    <div class="space-y-6">
                        @include('pages.masterKendaraan.components.ubah2')
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
                    ...
                    <div class="space-y-6">
                        {{-- Data kendaraan --}}
                        @include('pages.masterKendaraan.components.ubah3')
                    </div>

                    <!-- Right Column -->
                    <div class="space-y-6">
                        @include('pages.masterKendaraan.components.ubah4')
                    </div>
                </div>
