...
@section('content')
    <div class="p-3 md:p-4 max-w-full">
        ...
        <div class="bg-white rounded-xl shadow-lg p-3 md:p-4 mb-4">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
                <div class="flex items-center">
                    ...
                    <div>
                        <h1 class="text-xl md:text-2xl font-bold text-gray-800">List Rekom Kendaraan Mutasi / Numpang Uji Keluar</h1>
        ...
        <div class="bg-white rounded-xl shadow-lg p-3 md:p-4">
            <!-- Tools Section -->
            <form method="GET" action="{{ url()->current() }}" class="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 mb-4">
                <div class="flex flex-col md:flex-row items-center gap-3 w-full md:w-auto">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <select name="status" onchange="this.form.submit()"
                            ...
                            <option value="notyet" {{ request('status') == 'notyet' ? 'selected' : '' }}>Belum</option>
                            <option value="approved" {{ request('status') == 'approved' ? 'selected' : '' }}>Ditolak</option>
                            <option value="rejected" {{ request('status') == 'rejected' ? 'selected' : '' }}>Sudah</option>
                        </select>
                    </div>
                </div>
            </form>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-2 py-2 text-sm text-center whitespace-nowrap">
                                    <div class="flex justify-center items-center space-x-2">
                                        <a href="/rekom" class="text-emerald-600 hover:text-emerald-800" title="Ubah">
