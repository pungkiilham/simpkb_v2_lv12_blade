...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE penguji ADD tandatangan MEDIUMBLOB");
        DB::statement("ALTER TABLE penguji ADD tandatangan2 MEDIUMBLOB");
        DB::statement("ALTER TABLE penguji ADD tandatangan3 MEDIUMBLOB");
    }
