...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE kepaladinas ADD tandatangan MEDIUMBLOB");
        DB::statement("ALTER TABLE kepaladinas ADD tandatangan2 MEDIUMBLOB");
        DB::statement("ALTER TABLE kepaladinas ADD tandatangan3 MEDIUMBLOB");
    }
